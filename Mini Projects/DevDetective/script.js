...
function init(){
  ...
  if(value === null){//initialise dark-mode variable to false;
    lightModeProperties();
  }else if(value === "true"){ //darkMode = true -> dark mode enable karna h 
    darkModeProperties();
  }else if(value === "false"){//darMode = false -> light mode enable karna h
    lightModeProperties();
  }

  getUserData(url+"ImSayak");
}
